...
; GOSUB stack, max eight entriesKBD
...
; multiple of $2000.
        ...
        .org    $E000
        ;.export START          ; Primesh Commented
...
rdkey:  LDA     KBDCR           ; Read control register
        ...
        ;AND     #$7F            ; Primesh Added to remove leading 1    
        RTS                     ; and return
...
return_stmt:    LDY     #$4A
        ...
        LDA     gstk_plineh-1,Y
        STA     pline+1
        ;LDX     a:synpag+1,Y            ; force absolute addressing mode Primesh Changed it to compile
        LDX     synpag+1,Y 
        LDA     gstk_pverbh-1,Y
Le8be:  TAY
        TXA
